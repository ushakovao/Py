...
def step2():
    img = imageio.imread("../assets/img/shoe.jpg")
    g = img[:, :, 1]
    b = img[:, :, 2]

    saveRGB(np.zeros(g.shape),g,b,"showr.png")
...
def step2a():
    ...
    saveRGB(np.zeros(r.shape),r,b,"shoeg.png")
...
def step5():
    ...
    saveRGB(red,green,blue,'shoe_quantize.png')
